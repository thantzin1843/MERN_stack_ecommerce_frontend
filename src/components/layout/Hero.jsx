...
import heroImg from '../../assets/rabbit_one.jpg'
import { Link } from 'react-router-dom'
function Hero() {
  return (
    <section className='relative'>
        <img src={heroImg} className='w-full h-[400px] md:h-[600px] lg:h-[630px] object-cover object-center' alt="" />
        <div className="absolute bg-[#00000033] top-0  text-white w-full h-[400px] md:h-[600px] lg:h-[630px] flex flex-col items-center justify-center">
            <h1 className='text-center uppercase text-4xl md:text-9xl font-bold p-6 tracking-tighter mb-4'>Unbeatable
                <br /> Prices
            </h1>
