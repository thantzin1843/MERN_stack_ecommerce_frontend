...
function CategoryCreateForm({fetchCategoriesAndCollections}) {
  ...
  return (
        ...
        {
            appear && (
                <div className="fixed top-0 w-full bg-gray-200/70 z-55 min-h-full left-0 flex flex-col items-center justify-center p-3">
                <div className="w-full lg:w-1/3 bg-gray-700 rounded-lg p-5 min-h-1/2">
                    <div className="flex justify-between mb-5">
                        <h3 className='text-xl font-medium text-white text-center'>Create Category</h3>
                        <div>
