...
function EditProduct() {
    ...
    const [variants, setVariants] = useState([])
        ...
        const fetchProductDetails = async() =>{
            ...
            setHasVariants(data.product.hasVariants)
            ...
            setLength(data.product.dimensions.length);
    ...
    const removeVariant = (size,color) =>{
        console.log(variants, size,color)
    ...
    const removeTags = (tag) =>{
     ...
     const handleCheckboxChange = (event) => {
         console.log("variant is "+hasVariants)
    ...
    <div className='w-full lg:w-1/2 mx-auto'>
        ...
        <form onSubmit={handleUpdateProduct}>
...

           {
                    ...
                    <div className="grid grid-cols-2 gap-3 my-5">
                        ...
                        <div className=''>
                          ...
                          <select value={variant?.size} onChange={handleVariantChange} name="size" id="" className="border border-gray-400 p-2 rounded-md w-full">
                                ...
                                <option value="m" selected={"m"==variant.size}>M</option>
                                <option value="l" selected={"l"==variant.size}>L</option>
                                <option value="xl" selected={"xl"==variant.size}>xl</option>
                                <option value="xxl" selected={"xxl"==variant.size}>xxl</option>
                            </select>
                        </div>
                    </div>
            ...
            <button type="submit" className='my-5 bg-orange-500 text-white font-medium text-center w-full p-2 rounded-md'>Update Product</button>
